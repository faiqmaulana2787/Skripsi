...
@section('content')
    <div class="container mx-auto p-6">
        <h2 class="text-2xl font-bold mb-4 text-center">Edit Kategori - {{ $ujian->nama_ujian }}</h2>
        ...
        <form action="{{ route('kategori.update', ['ujian_id' => $ujian->id, 'kategori_id' => $kategori->id]) }}"
            method="POST" class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow">
            @csrf
            @method('PUT')
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="durasi" name="durasi" value="{{ $kategori->durasi }}"
                    class="border border-gray-300 rounded w-full p-2 focus:ring focus:ring-blue-300" required>
            </div>
